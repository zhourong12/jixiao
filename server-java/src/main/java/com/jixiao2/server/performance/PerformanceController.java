...
public class PerformanceController {
  ...
  public Map<String, Object> list(
    ...
    Map<String, Object> result =
        performanceService.list(
            userId, status, focus, period, departmentId, employeeName, page, pageSize);
  ...
  public Map<String, Object> export(
    ...
    return performanceService.exportData(
        userId, status, focus, period, departmentId, employeeName);
  }
  ...
  public Map<String, Object> listSupervisorCalibrationQueue(
    ...
    return performanceService.listSupervisorCalibrationQueue(
        userId, period, departmentId, employeeName, page, pageSize);
  }
