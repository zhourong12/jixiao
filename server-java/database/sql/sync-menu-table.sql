...
-- admin_assessment_rules -> /admin/assessment-rules
...
DELETE FROM `role_menu` WHERE `menu_key` IN ('admin_notifications', 'admin_system_config', 'home');
DELETE FROM `menu` WHERE `menu_key` IN ('admin_notifications', 'admin_system_config', 'home');
