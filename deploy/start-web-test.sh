#!/usr/bin/env bash
# 测试环境前端（单文件，无额外 source）
#   cp deploy/.env-test.example deploy/.env-test
#   ./deploy/start-web-test.sh
set -euo pipefail
...
# ---------- 测试环境参数 ----------
WEB_PORT=80
WEB_DOMAIN="test-kpi.ccka.com"
API_UPSTREAM="127.0.0.1:8082"
RUNTIME_DIR="$ROOT/deploy/runtime-test"
LOG_DIR="$RUNTIME_DIR/logs"
LOG_RETENTION_DAYS=15
SERVER_NAME="$WEB_DOMAIN"
SITE_NAME="jixiao2-test"
ENV_FILE="$ROOT/deploy/.env-test"
